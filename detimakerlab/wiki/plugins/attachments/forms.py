...
from detimakerlab.wiki.core.permissions import can_moderate
from detimakerlab.wiki.plugins.attachments import models
from detimakerlab.wiki.plugins.attachments.models import IllegalFileExtension
