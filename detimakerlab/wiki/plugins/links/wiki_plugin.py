...
from detimakerlab.wiki.plugins.links import settings, views
from detimakerlab.wiki.plugins.links.mdx.djangowikilinks import WikiPathExtension
from detimakerlab.wiki.plugins.links.mdx.urlize import makeExtension as urlize_makeExtension
