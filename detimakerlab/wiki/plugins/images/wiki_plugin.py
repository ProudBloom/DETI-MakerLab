...
from detimakerlab.wiki.plugins.images import forms, models, settings, views
from detimakerlab.wiki.plugins.images.markdown_extensions import ImageExtension
